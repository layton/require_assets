...
== Quick overview of the API
	...
	# require_css is like require_js but for CSS.
...
require_js and require_css, include_required_js and include_requried_css
require assets just once:		
 ...
 included with require_js, it will only be included once in the header.
